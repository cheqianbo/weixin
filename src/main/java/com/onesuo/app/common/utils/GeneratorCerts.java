 ...
 * 自动生成MyBatis的java文件
 */
public class GeneratorCerts {
    /**
     * 必要配置
     */
    protected String root_path = "C:\\Users\\cheqianbo\\Desktop\\file"; // 生成的文件存放目录
    protected String customTableNames[] = {
            "sys_operlog","sys_organization","sys_permission","sys_permission_filter","sys_role","sys_role_permission","sys_user"
    }; //表名, 如果为空则生成该数据库内全部的表对应的Java文件

    /**
     * 数据库相关配置
     */
    protected String url = "jdbc:mysql://192.168.254.129:3306/one_suo?useSSL=false";
    protected String driverName = "com.mysql.jdbc.Driver";
    protected String user = "ceshi";
    protected String password = "ceshi";
     ...
     * 包路径配置
     */
    private final String bean_package = "com.quanmin110.certextraction.model.certs";
    private final String dao_package = "com.quanmin110.certextraction.dao.certs";
    private final String query_package = "com.quanmin110.certextraction.model.query.certs";
    private final String service_package = "com.quanmin110.certextraction.service.certs";
    private final String controller_package = "com.quanmin110.certextraction.controller.certs";
    ...
    public static void main(String[] args) {
        try {
            GeneratorCerts generator = new GeneratorCerts();
            generator.generate();
            // 自动打开生成文件的目录
